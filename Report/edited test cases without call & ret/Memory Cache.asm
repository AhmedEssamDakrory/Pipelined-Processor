...
jmp R0 #Instr cache read miss for block starting with 118 each time we call. Data cache write miss for the first iteration in loop for block starting with 7F8.
OUT R5
INC R4
JMP R1 #jump to 18
...
jmp R0#Instr cache read miss for block starting with 118 for first loop iteration.
